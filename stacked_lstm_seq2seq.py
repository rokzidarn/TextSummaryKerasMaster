...
def seq2seq_architecture(latent_size, embedding_size, vocabulary_size, batch_size, epochs):
    ...
    encoder_lstm_1 = tf.keras.layers.LSTM(latent_size, name='Encoder-LSTM-1', return_sequences=True, return_state=True)
    encoder_lstm_2 = tf.keras.layers.LSTM(latent_size, name='Encoder-LSTM-2', return_state=True)
    ...
    decoder_lstm_1 = tf.keras.layers.LSTM(latent_size, name='Decoder-LSTM-1', return_sequences=True, return_state=True)
    decoder_lstm_2 = tf.keras.layers.LSTM(latent_size, name='Decoder-LSTM-2', return_sequences=True, return_state=True)
    ...
    decoder_initial_state_c1 = tf.keras.layers.Input(shape=(latent_size,), name='Decoder-Init-C1')
    decoder_initial_state_h2 = tf.keras.layers.Input(shape=(latent_size,), name='Decoder-Init-H2')
    decoder_initial_state_c2 = tf.keras.layers.Input(shape=(latent_size,), name='Decoder-Init-C2')
    ...
    decoder_model = tf.keras.Model(inputs=[decoder_inputs] + [decoder_initial_state_h1, decoder_initial_state_c1,
