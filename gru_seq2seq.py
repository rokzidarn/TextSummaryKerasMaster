...
def plot_loss(history_dict):
    ...
    plt.ylabel('Loss')
    plt.legend()
    fig.savefig('data/models/gru_train.png')
    ...
    plt.ylabel('Loss')
    plt.legend()
    fig.savefig('data/models/gru_valid.png')
...
def seq2seq_architecture(latent_size, vocabulary_size, embedding_matrix, batch_size, epochs, train_article, train_summary, train_target):
    ...
    _, state_h = GRU(latent_size, return_state=True, dropout=0.2, recurrent_dropout=0.2,
    ...
    gru_out, gru_state_h_out = seq2seq_model.get_layer('Decoder-GRU')(
    ...
    decoder_model = Model([decoder_inputs, inference_state_h_input], [dense_out, gru_state_h_out])
